...
{    
    ...
    for (int row=rowstart; row<rowend; row++)
    {
        ...
        testmpc.genperm(row, norm_method);
...
int main(int argc, char* argv[])
{
    ...
    // string normalized = "/gpfs/commons/groups/gursoy_lab/aychoi/eqtl/mpc/securesort/output/private_deseq2_invcdf_gmg_normalized.tsv";
    // resultVec1 = getMatrixFile(normalized, 0, 16242, false, true);
    ...
    // writematrixToTSV(res_A, to_write);
